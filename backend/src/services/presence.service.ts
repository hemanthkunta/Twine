...
export class PresenceService {
  ...
  static registerConnection(userId: string, socket: WebSocket, deviceId?: string): ConnectedClient {
  ...
  static broadcastToUsers(userIds: string[], frame: WSFrame, excludeSocket?: WebSocket) {
    const data = JSON.stringify(frame);
  ...
  static broadcastTyping(chatId: string, senderId: string, memberIds: string[], isTyping: boolean) {
